...
const fashionNavItems: FashionNavItem[] = [
  { path: "/fashion", label: "New Arrivals" },
  { path: "/fashion/editorial", label: "Editorial Edit" },
  { path: "/fashion/collections", label: "Collections" },
  { path: "/fashion/style-notes", label: "Style Notes" }
];
